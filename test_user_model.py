...
class UserModelTestCase(TestCase):
    ...
    def setUp(self):
        ...
        u2 = User.signup("test1", "email@email.com", "password", None)
        uid2 = 4567
        u2.id = uid2
    ...
    def test_valid_signup(self):
        u_test = User.signup("tester", "test@test.com", "password", None)
        uid= 45555
        u_test.id = uid
        db.session.commit()
    ...
    def test_invalid_username_signup(self):
        invalid = User.signup(None, "testy@test.com", "password", None)
        uid = 4567899999
        invalid.id = uid
    ...
    def test_invalid_email_signup(self):
        with self.assertRaises(ValueError) as context:
            User.signup("testina", "email@email.com", "", None)

        with self.assertRaises(ValueError) as context:
            User.signup("testina" "email@email.com", None, None)
